...
## The first function creates a "matrix" that is actually a list of four functions, that allow us to perform diferent procedures
## to the given matrix and it's inverse.
...
## In both cases it returns the inverse of if 
